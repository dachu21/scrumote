...
insert into permission_t (id, version, name) values (1, 1, 'ADMIN_PERMISSION');
insert into permission_t (id, version, name) values (2, 1, 'STANDARD_PERMISSION');
alter sequence permission_seq restart with 3;
